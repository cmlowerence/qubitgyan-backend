...
PRACTICE_MIN_COUNT = 15
PRACTICE_MAX_COUNT = 20
PRACTICE_BLACKLIST_DAYS = 15
WOTD_BLACKLIST_DAYS = 15
TRENDING_CACHE_SECONDS = 900
WORD_CACHE_SECONDS = 86400

NIGHTLY_IMPORT_SEED_LIMIT = 8
NIGHTLY_IMPORT_RELATED_LIMIT = 4
WOTD_MIN_DIFFICULTY_SCORE = 0.45
PRACTICE_MIN_DIFFICULTY_SCORE = 0.25
MIN_MEANINGS_FOR_SELECTION = 1
